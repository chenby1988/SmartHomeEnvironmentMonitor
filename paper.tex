...
系统采用分层架构设计，如图 \ref{fig:architecture} 所示的逻辑结构。
...
\begin{enumerate}[label={[\arabic*]},leftmargin=2em,itemsep=2pt]
    ...
    \item QEMU Developers. QEMU System Emulation User's Manual[EB/OL]. https://qemu.readthedocs.io/, 2024.
    \item GNU Project. Using the GNU Compiler Collection (GCC)[EB/OL]. https://gcc.gnu.org/onlinedocs/, 2024.
    ...
    \item FreeRTOS.org. FreeRTOS Configurations[EB/OL]. https://www.freertos.org/a00110.html, 2024.
    \item GitHub, Inc. SmartHomeEnvironmentMonitor Repository[EB/OL]. https://github.com/chenby1988/SmartHomeEnvironmentMonitor, 2024.
\end{enumerate}
